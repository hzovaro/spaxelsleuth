...
cmap_dict = {
    ...
    "delta log O3 (1/0)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log O3 (2/1)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log O1 (1/0)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log O1 (2/1)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log N2 (1/0)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log N2 (2/1)": copy.copy(plt.cm.get_cmap("PiYG")),
    "delta log S2 (1/0)": copy.copy(plt.cm.get_cmap("PiYG")),
...
vmin_dict = {
    ...
    "m_r": -25,
    "z_spec": 0,
    "delta log O3 (1/0)": -1.0,
    "delta log O3 (2/1)": -1.0,
    "delta log O1 (1/0)": -0.5,
    "delta log O1 (2/1)": -0.5,
    "delta log N2 (1/0)": -0.5,
    "delta log N2 (2/1)": -0.5,
    "delta log S2 (1/0)": -0.5,
...
label_dict = {
     ...
     "m_r": r"$M_r$ (mag)",
     "z_spec": r"$z$",
     "delta log O3 (1/0)": r"$\Delta$ log O3 (1/0)",
     "delta log O3 (2/1)": r"$\Delta$ log O3 (2/1)",
     "delta log O1 (1/0)": r"$\Delta$ log O1 (1/0)",
     "delta log O1 (2/1)": r"$\Delta$ log O1 (2/1)",
     "delta log N2 (1/0)": r"$\Delta$ log N2 (1/0)",
     "delta log N2 (2/1)": r"$\Delta$ log N2 (2/1)",
     "delta log S2 (1/0)": r"$\Delta$ log S2 (1/0)",
