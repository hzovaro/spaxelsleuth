...
cmap_dict = {
    ...
    "delta v_gas (2/1)": copy.copy(plt.cm.get_cmap("coolwarm")),
    "delta v_gas (3/2)": copy.copy(plt.cm.get_cmap("coolwarm")),
    "r/R_e": copy.copy(plt.cm.get_cmap("gnuplot2_r")),
    "R_e (kpc)": copy.copy(plt.cm.get_cmap("gnuplot2_r")),
    "i (degrees)": copy.copy(plt.cm.get_cmap("Spectral_r")), 
    ...
    "log mean HALPHA A/N": copy.copy(plt.cm.get_cmap("jet")),
...
label_dict = {
     ...
     "log(M/R_e) (MGE)": r"$\log_{10}(M/R_e\,[\rm M_\odot\,kpc^{-1}])$ (MGE)",
     "log(M/R_e^2)": r"$\log_{10}(M/R_e^2\,[\rm M_\odot\,kpc^{-2}])$",
     "log(M/R_e^2) (MGE)": r"$\log_{10}(M/R_e^2\,[\rm M_\odot\,kpc^{-2}])$ (MGE)",
     ...
     "log mean HALPHA A/N (1R_e)": r"$log_{10} \langle {\rm H}\alpha \rangle$ A/N ($1R_e$)",
     "log mean HALPHA A/N": r"$log_{10} \langle {\rm H}\alpha \rangle$ A/N",
...
fname_dict = {
     ...
     "log(M/R_e) (MGE)": "mstar_over_re_mge",
     "log(M/R_e^2)": "mstar_over_re2",
     "log(M/R_e^2) (MGE)": "mstar_over_re2_mge",
     "g - i colour": "g-i",
     "Morphology (numeric)": "morphology",
     "M_r": "M_r",
     "z": "z",
     ...
     "log mean HALPHA A/N": "log_mean_HALPHA_AN",
